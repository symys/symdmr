...
function About() {
  ...
  return (
    <div className="bg-[#111827] min-h-full text-[#F7F5EB] font-nunito gap-20 flex flex-col lg:p-24 p-10">
      <div className="font-nunito text-2xl lg:w-[50em] flex flex-col self-center gap-8">
        <div>
          ...
          technology as a hobby and later I decided to make it my job. Frontend
          development made me think that it is in communication with different
          areas (backend and UX/UI) just like urban and regional planning, and I
          think this is very enjoyable.
        </div>
        <div>
          Being intertwined with design and technology and developing responsive
          web applications for users makes me happy. Because of this, I found
          myself close to frontend development and I keep learning new things
          every day. I believe that I can be a wanted member of a team where I
          can use my communication, responsibility, problem solving and other
          social skills.
        </div>
        <div>
